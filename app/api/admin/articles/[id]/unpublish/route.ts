// Articles unpublish action route
// Per 20-api-articles.md Section 8 (Unpublish)
// Per 15-article-publishing.md Section 5 (Unpublishing workflow)
 ...
 * Unpublish an article (transition published → draft)
 * Per 20-api-articles.md Section 8
 * Per 15-article-publishing.md Section 5: Preserves publishedAt (historical record)
 */
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // Unpublish article via service per 02-admin-architecture.md Section 5.2
    const article = await articlesService.unpublishArticle(id);
